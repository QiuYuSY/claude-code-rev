...
- 能解释权限为什么是运行时边界
- 能解释 message 为什么是统一历史模型
- 能解释 context assembly 为什么必须显式化

完成标准：

- 你能用自己的话解释“权限、消息、上下文为什么必须一起设计”
...
1. 权限不只是弹窗，而是能力边界
2. `message` 不只是聊天记录，而是系统历史
3. 上下文不是一大段 prompt，而是装配出来的

可以先跳过：

- `03-guided-reading...` 里太细的函数分支
- `06-source-index.md` 的代码锚点
